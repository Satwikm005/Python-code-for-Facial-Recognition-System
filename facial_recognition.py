...
image = CurrentFolder+'\\Rohit.jpg'
image2 = CurrentFolder+'\\Satwik.jpg'
# Get a reference to webcam #0 (the default one)
video_capture = cv2.VideoCapture(0)
# Load a sample picture and learn how to recognize it.
Rohit_image = face_recognition.load_image_file(image)
Rohit_face_encoding = 
face_recognition.face_encodings(Rohit_image)[0]
# Load a second sample picture and learn how to recognize it.
Satwik_image = face_recognition.load_image_file(image2)
Satwik_face_encoding = 
face_recognition.face_encodings(Satwik_image)[0]
...
face_encoding)
 ...
 serial_data = s.read()
 if(serial_data == b'p'):
 print(" Memebers present inside home no need 
to send image")
 ...
 i += 1
 Sender_Email = 
"guptarohitkumar2580@gmail.com"
 Reciever_Email = 
"rohit.vitofficial@gmail.com"
 Password = "ettldvgzpohrdmnw" #type your 
app generated password here
 newMessage = EmailMessage() 
 newMessage['Subject'] = "Alert Theft inside 
your home" 
 newMessage['From'] = Sender_Email 
 newMessage['To'] = Reciever_Email 
 newMessage.set_content('Let me know what 
you think. Image attached!') 
 with open('opencv.png', 'rb') as f:
 image_data = f.read()
 image_type = imghdr.what(f.name)
 image_name = f.name
 newMessage.add_attachment(image_data, 
maintype='image', subtype=image_type, filename=image_name)
 with smtplib.SMTP_SSL('smtp.gmail.com', 
465) as smtp:
 smtp.login(Sender_Email, Password) 
 smtp.send_message(newMessage)
 elif((name == "Rohit_Gupta") or (name == "Satik")):
 s.write(b'1')
